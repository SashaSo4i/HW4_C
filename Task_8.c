...
// Эта задача не просто если культурно выражаться разработало мне мозги, но и заставила часа 3 учить новые функции в Си и в целом чутка углубиться в динамическое программировние,а также узнать что в Си в отличчи от плюсов нет sort.
...
int main() {
    ...
    if (num > 2) { //ну и соответсвенно если элементов 2 и более. 
